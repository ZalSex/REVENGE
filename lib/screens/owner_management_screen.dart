    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(res['success'] == true ? 'Session berhasil dihapus' : (res['message'] ?? 'Gagal'),
      ...
      if (mounted) ScaffoldMessenger.of(context).showSnackBar(SnackBar(
        content: Text('Error: $e', style: const TextStyle(fontFamily: 'ShareTechMono')),
  ...
  Future<void> _transferSender(String senderId, String targetUserId) async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
            res['success'] == true ? res['message'] : (res['message'] ?? 'Gagal Memindah Sender'),
            style: const TextStyle(fontFamily: 'ShareTechMono'),
          ),
          backgroundColor: res['success'] == true ? Colors.green.shade700 : Colors.red.shade700,
        ));

...
class _WaCallScreenState extends State<WaCallScreen> {
  ...
  Future<void> _start() async {
    if (_selectedSenderId == null) { _snack(tr('pick_sender'), isError: true); return; }
    if (_targetCtrl.text.isEmpty) { _snack('Masukkan Nomor Target', isError: true); return; }
  ...
  void _snack(String msg, {bool isError = false}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      backgroundColor: isError ? Colors.red.shade800 : _blue,

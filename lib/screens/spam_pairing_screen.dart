...
class _SpamPairingScreenState extends State<SpamPairingScreen> {
  ...
  Future<void> _start() async {
    ...
    if (number.isEmpty) { _snack('Masukkan Nomor Target', isError: true); return; }
    final count = int.tryParse(_countCtrl.text.trim()) ?? 5;
    if (count < 1 || count > 50) { _snack('Jumlah 1–50', isError: true); return; }
  ...
  Future<void> _stop() async {
    ...
    try {
      ...
      _snack('Spam Pairing Dihentikan');
    } catch (_) {
